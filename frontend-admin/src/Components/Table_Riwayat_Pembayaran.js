...
if(this.state.found){
let data_pembayaran =
JSON.parse(JSON.stringify(response.data.pembayaran))
this.setState({
...
leading-tight text-gray-800 text-center">Riwayat Pembayaran
Siswa</h4>
</div>
</div>
</div>
...
text-gray-900">{this.state.action.toUpperCase()} Pembayaran</h3>
<p
class="mt-1 text-sm text-gray-600">
Gunakan
untuk {this.state.action.toUpperCase()} Pembayaran<br/><br/>
Syarat
Penggunaan: <br/>
- Wajib
memasukan semua kolom
</p>
</div>
</div>
<div class="mt-5
...
<form
method="POST" onSubmit={ev => this.save(ev)}>
<div
...
<label for="nisn" class="block text-sm font-medium
text-gray-700">NISN</label>
...
<label for="id_petugas" class="block text-sm font-medium
text-gray-700">Petugas</label>
...
<div class="col-span-6 sm:col-span-3">
<label for="tgl_bayar" class="block text-sm font-medium
text-gray-700">Tanggal Bayar</label>
...
<div class="col-span-6 sm:col-span-3">
<label for="bulan_dibayar" class="block text-sm font-medium
text-gray-700">Bulan Dibayar</label>
<input type="number" name="bulan_dibayar" id="bulan_dibayar"
...
<div class="col-span-6 sm:col-span-3">
<label for="tahun_dibayar" class="block text-sm font-medium
text-gray-700">Tahun Dibayar</label>
<input type="number" name="tahun_dibayar" id="tahun_dibayar"
...
<div class="col-span-6 sm:col-span-3">
<label for="id_spp" class="block text-sm font-medium
text-gray-700">SPP</label>
...
<div class="col-span-6 sm:col-span-3">
<label for="jumlah_bayar" class="block text-sm font-medium
...
<div className={`${this.state.modal}
opacity-25 fixed inset-0 z-40 bg-black`}></div>
</div>
</div>
...
class="text-sm text-gray-900">
Rp{
item.jumlah_bayar} - Rp{item.spp.nominal}
</div>
<span
class="px-2 inline-flex text-xs leading-5 font-semibold
...
<li
className="flex items-center mr-3 mt-3 md:mt-0">
<span
className="mr-2">
...
fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16
16">
...
<span
className="mr-2">
<button className="bg-red-500 text-white active:bg-red-600
font-bold uppercase text-sm px-6 py-3 rounded shadow
hover:shadow-lg outline-none focus:outline-none mr-1 mb-1
ease-linear transition-all duration-150"
type="button"
