...
if(this.state.found){
let data_kelas =
JSON.parse(JSON.stringify(response.data.kelas))
this.setState({
...
leading-tight text-gray-800 text-center">Tabel Daftar kelas</h4>
</div>
</div>
</div>
<div>
...
text-gray-900">{this.state.action.toUpperCase()} Kelas</h3>
<p
class="mt-1 text-sm text-gray-600">
Gunakan
untuk {this.state.action.toUpperCase()} Kelas<br/><br/>
Syarat
Penggunaan: <br/>
- Wajib
...
<label for="nama_kelas" class="block text-sm font-medium
text-gray-700">Nama Kelas</label>
...
<div class="col-span-6 sm:col-span-3">
<label for="kompetensi_keahlian" class="block text-sm font-medium
text-gray-700">Kompetensi Keahlian</label>
<input type="text" name="kompetensi_keahlian"
id="kompetensi_keahlian" autocomplete="kompetensi_keahlian"
class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block
w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
value={this.state.kompetensi_keahlian}
onChange={ev => this.setState({kompetensi_keahlian:
ev.target.value})}
required/>
</div>
</div>
